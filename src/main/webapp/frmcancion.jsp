        ...
        <div class="content">
            ...
            <form action="CancionControlador" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="time" class="form-control" name="duracion" value="${cancion.duracion}" step="1" min="00:00:00" max="59:59" placeholder="mm:ss" pattern="[0-5][0-9]:[0-5][0-9]">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="cancion_lk" class="form-label">Canción</label>
                    <input type="text" class="form-control" name="cancion_lk" value="${cancion.cancion_lk}" placeholder="Canción">
                </div>
